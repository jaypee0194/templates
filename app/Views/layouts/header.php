...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <link rel="icon" href="<?=base_url() ?>/templates/images/favicon.ico" type="image/x-icon">
    <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Montserrat:300,400,700%7CPoppins:300,400,500,700,900">
    <link rel="stylesheet" href="<?=base_url() ?>/templates/css/bootstrap.css">
    <link rel="stylesheet" href="<?=base_url() ?>/templates/css/fonts.css">
  ...
  <!--Footer-->
  <a class="section section-banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" target="_blank" style="background-image: url(images/background-01-1920x310.jpg); background-image: -webkit-image-set( url(images/background-01-1920x310.jpg) 1x, url(images/background-01-3840x620.jpg) 2x )"><img src="<?=base_url() ?>/templates//images/foreground-01-1600x310.png" srcset="<?=base_url() ?>/templates/images/foreground-01-1600x310.png 1x, images/foreground-01-3200x620.png 2x" alt="" width="1600" height="310"></a>
     <footer class="section footer-classic section-sm">
        <div class="container">
          <div class="row row-30">
            <div class="col-lg-3 wow fadeInLeft">
              <!--Brand--><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logo-default-200x34.png" alt="" width="100" height="17"/><img class="brand-logo-light" src="<?=base_url() ?>/templates/images/logo-inverse-200x34.png" alt="" width="100" height="17"/></a>
    ...
    <script src="<?=base_url() ?>/templates//js/core.min.js"></script>
    <script src="<?=base_url() ?>/templates/js/script.js"></script>
